 ...
 * 
 * @param username the username of the new user it's checked by username_is_valid @see username_is_valid
 * @param password the password of the new user it's checked by password_is_valid @see password_is_valid
